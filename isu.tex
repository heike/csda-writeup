...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \caption{Map of the Gulf Coast area overlaid by locations at which PAH measurements were taken (yellow). Orange dots represent locations that are at a chronic level, red dots mark locations with an acute level. This figure represents data pooled over both time and position. More dangerous points are plotted on top of less dangerous points. The most dangerous area is along the outermost shore of Louisiana: many locations here have PAH levels at or above chronic or acute benchmarks.}
   \label{pah-map}
\end{figure}
