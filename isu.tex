...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \caption{Satellite map of a part of the Gulf of Mexico. The location of the Deep Water Horizon rig is marked by a white cross. Each dot on top of the map represents the sighting of one dead animal: XXX birds (orange), XXX sea turtles (yellow), and XXX dolphins and whales (red). }
   \label{deaths}
\end{figure}
...
Various chemicals were sampled in the Gulf of Mexico during the months following the oil spill. This analysis focuses on Polycyclic Aromatic Hydrocarbons firstly because of their direct relationship with oil and secondly because of their toxicity to wildlife. Polycyclic Aromatic Hydrocarbons, or PAHs, are semi-volatile organic substances which come mainly from oil and the burning of oil. However, they can also come XXX exhaust and from the burning of gas, coal, garbage and other organic substances \citep{pah}.   Many of these substances are considered carcinogenic, mutagenic, and teratogenic and all are considered harmful to the health of living organisms. Based on EPA guidelines \citep{pah},  this information  was added to the given data. \\
...
In order to keep track of the oil movement, NOAA pulled most of its resources into the Gulf area to measure these characteristics:  XXX boats, XXX floats
, and XXX gliders, which recorded salinity, temperature, and depth measurements at various locations in the Gulf of Mexico. 
...
\end{figure}
Figure \ref {salinity-timeline} pictures  salinity measurements over the whole data collection period. Points are color coordinated by time to link left and right display. XXX \% of the salinity measurements stayed within a close range of values between 34 and 38 mg/l.
...
\begin{eqnarray*}
\lefteqn{\text{Acute/Chronic Benchmark Value} =} \\
&& \frac{1}{\text{Organic Carbon}} \sum \frac{\text{Alkylation Multiplier} \times \text{Measured Amount of Substance} (\mu g/kg)}{\text{Acute/Chronic Potency Divisor}}
\end{eqnarray*}
