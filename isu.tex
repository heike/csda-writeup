...
Alkylation Multiplier* & calculated values \\
Acute Potency Divisor* & calculated values\\
Chronic Potency Divisor* & calculated values  
\end{tabular}
\label{table.animal}
...
*calculated according to \citet{pah-benchmark} and added to data set}
\end{table}
